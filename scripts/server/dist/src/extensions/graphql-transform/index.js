...
exports.transformRest = exports.transformGraphql = void 0;
/* let data = {
   data: {
      articles: {
         data: [
 ...
 * @param data
 */
function transformGraphql(data) {
    data = data.data;
    let ret = {};
    for (let key in data) {
        let item0 = data[key];
        if (isUnit(item0)) {
            ...
            let items = (item0 === null || item0 === void 0 ? void 0 : item0.data) || [];
            ret[key] = ret[key] || [];
...
exports.transformGraphql = transformGraphql;
function transformGraphqlItem(data) {
    if (isUnit(data))
        return data;
...
exports.transformRest = transformRest;
